...
namespace PodioAPI.Services
{
    public class CommentService
    {
        ...
        public async Task<long> AddCommentToObject(string type, long id, string text, string externalId = null,
            List<long> fileIds = null, string embedUrl = null, long? embedId = null, bool alertInvite = false,
        ...
        ///     area
        /// </param>
        public async Task<dynamic>  UpdateComment(long commentId, string text, string externalId = null, List<long> fileIds = null,
            string embedUrl = null, long? embedId = null)
        {
